  ...
  return (
    <nav className="flex items-center justify-between flex-wrap bg-white p-6 fixed w-full z-10 top-0 drop-shadow-2xl ">
      ...
      <div className="flex items-center flex-shrink-0 text-white ">
        <a className="text-black no-underline hover:text-zinc-800 hover:no-underline justify-center items-center mr-6" href="#">
      ...
      <div className="flex w-1/4 lg:hidden">
        <Button id="nav-toggle" onClick={() => setOpen(true)} className="flex items-center px-3 py-2 border rounded text-gray-500 border-gray-600 hover:text-white hover:border-white">
      ...
      <div className="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden pt-6 lg:pt-0" id="nav-content">
        <ul className="list-reset lg:flex justify-end flex-1 items-center">
          <li className="mr-3">
            <a className="inline-block py-2 px-4 text-black no-underline" href="#">
              Home
            </a>
          </li>
          <li className="mr-3">
